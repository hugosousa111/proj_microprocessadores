 ...
 void envia_byte_lcd(char endereco,char dado)
{
 ...
 __delay_us(40); // Aguarda 40us para estabilizar o LCD                                                       // Retorna ao ponto de chamada da função
}
...
void inicializa_lcd(void)
{
 ...
 //contador de caracteres e retornar o cursor à posição inicial (0x80).
